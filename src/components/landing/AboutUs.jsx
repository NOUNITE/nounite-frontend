  ...
  return (
    <div className="w-full  my-12 ">
      ...
      <div className="flex justify-between px-10 sm:px-5 flex-col lg:flex-row md:flex-row  lg:px-8 md:px-5 py-16">
        <div>
          <h1 className="font-poppins text-center lg:text-[40px] text-[30px] sm:text-[20px] text-textHover font-semibold border border-btnColor border-solid rounded-[200%] py-2 px-8">
            What is NOUNITE?
          </h1>
