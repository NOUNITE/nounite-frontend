...
const Navbar = () => {
  let Links = [
    { name: "Home", link: "https://nounite.netlify.app/#home" },
    { name: "Features", link: "/" },
    { name: "About", link: "https://nounite.netlify.app/#aboutus" },
    { name: "Blog", link: "/" },
    { name: "Faq", link: "https://nounite.netlify.app/#faq" }
  ];
    ...
    <div className="w-full sticky bg-white top-0 left-0 px-1 lg:px-5 md:px-0">
      <div className="md:flex items-center justify-between md:w-full py-4 md:px-4 px-7">
        ...
        >
          ...
          <button
            onClick={handleClick}
            className="block md:hidden  bg-btnColor text-white px-5 py-2 rounded-md font-poppins font-medium text-base"
          >
            Join the Waitlist
          </button>
        </ul>
        <div className="md:pl-5 ">
          <button
            onClick={handleClick}
            className="hidden md:block bg-btnColor text-white w-[10rem]  px-2 py-2 rounded-md font-poppins font-medium text-base md:text-sm"
          >
            Join the Waitlist
          </button>
        </div>
